...
<h1>Ingresar datos</h1>
    <form action="login_tienda.php" method="POST">
    <input type="text" required name="nom_tienda" placeholder="Ingresar nombre de la tienda">
    <input type="text" name="nom_propi" required placeholder="Nombre completo del propietario">
    <input type="number" name="documento" required placeholder="Numero de documento">
    <input type="number" name="tel" required placeholder="Numero de Telefono">
    <input type="text" name="dire" required placeholder="Direccion de la tienda">
...
if (isset($_POST["guardar"])) {
     $obj->cargardatos_tienda($_POST["nom_tienda"], $_POST["nom_propi"], $_POST["documento"], $_POST["tel"], $_POST["dire"], $_POST["correo"], $_POST["contraseña"]);
      $obj->guardar_tienda();  
}
